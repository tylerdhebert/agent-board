  ...
  return (
    <header className="flex items-center justify-between px-4 py-2.5 border-b border-[#1e1e2a] bg-[#0a0a0f] shrink-0">
      <div className="flex items-center gap-3">
        <span className="text-[#e2e8f0] font-mono font-bold text-sm tracking-tight">
          agent-board
        </span>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-mono text-[#475569] hover:text-[#94a3b8] border border-[#2a2a38] hover:border-[#3a3a4a] rounded-sm transition-colors"
        >
          <span>⚙</span>
          <span>Admin</span>
        </button>
